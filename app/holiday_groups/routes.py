...
@holiday_group_router.delete("/") # , dependencies=[Depends(JWTBearer("super_user"))])
...
@holiday_group_router.put("/update", response_model=HolidayGroupSchema) # , dependencies=[Depends(JWTBearer("super_user"))])
