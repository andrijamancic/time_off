...
@holiday_group_dates_router.delete("/") # , dependencies=[Depends(JWTBearer("super_user"))])
...
@holiday_group_dates_router.put("/update", response_model=HolidayGroupDateSchema) # , dependencies=[Depends(JWTBearer("super_user"))])
